...
for coll_name in collections:
    if coll_name == 'biology_questions':
        print("Skipping biology_questions - already copied fully.")
        continue
    ...
    for q in questions:
        ...
        # Optional: tag them to differentiate if needed, but not strictly necessary
...
print(f"Total questions copied this time: {total_copied}")
client.close()
