...
OUTPUT_DIR = os.path.join(REPO_ROOT, "analysis_service", "private_data", "pinnacle-27")
...
TITLE          = "Pinnacle-27 Engineering Batch — Chapter Test"
DATE           = "2026-09-14T04:00:00+00:00"
EXAM_TYPE      = "JEE"
BATCH_NAME     = "PINNACLE-27_Engg"
SCHEMA_VERSION = "1.0"
...
def load_all():
    responses_raw    = load_json("pinnacle_27_batch_responses.json")
    answer_key_raw   = load_json("answer_key_27.json")
    questions_raw    = load_json("parsed_PINNACLE-27.json")
    difficulty_raw   = load_json("final_question_27_difficulty.json")
    taxonomy_raw     = load_json("taxonomy_map_27.json")
