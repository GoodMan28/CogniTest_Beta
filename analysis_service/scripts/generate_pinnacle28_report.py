...
OUT_FILE     = r"C:\Users\Abhineet Anand\.gemini\antigravity-ide\brain\f8a0157b-f356-4ee6-8ec3-c2e6512208cc\pinnacle28_analysis_report.md"
...
# ── MongoDB helpers ───────────────────────────────────────────────────────────
def get_data(db):
    test = db.tests.find_one({"instituteId": INSTITUTE_ID, "title": "PINNACLE-28 Periodic Test", "analysisDemo.status": "PUBLISHED"})
